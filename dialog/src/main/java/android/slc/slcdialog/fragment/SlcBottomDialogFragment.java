...
public class SlcBottomDialogFragment extends AppCompatDialogFragment implements SlcPopup.AlertDialogOperate {
    ...
    private static class MyOnCancelListener implements DialogInterface.OnCancelListener {
        ...
        MyOnCancelListener(SlcBottomDialogFragment slcDialogFragment) {
    ...
    private static class MyOnDismissListener implements DialogInterface.OnDismissListener {
        ...
        MyOnDismissListener(SlcBottomDialogFragment slcDialogFragment) {
     ...
     * @param builder
     */
    public void setDialog(SlcBottomSheetAlertDialog.Builder builder, FragmentManager fragmentManager) {
